...
<%@ page import="com.ztt.dao.MusicDaoImpl" %>
<%@ page import="com.ztt.dao.User_operation_historyImpl" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
...
<script type="text/javascript">
    function confirm_Collect(userid,songid) {
        $.ajax({
            ...
            success:function (backdata) {
                //alert(backdata);
                $.getElementById('collect_operation').onclick=function (ev) { cancle_Collect(userid,songid) };
                var collect_pic=$.getElementById("collect-image");
                alert(collect_pic);
    ...
    function cancle_Collect(userid,songid) {
        $.ajax({
            ...
            success:function (backdata) {
                //alert(backdata);
                $.getElementById('collect_operation').onclick=function (ev) { confirm_Collect(userid,songid) };
                var collect_pic=$.getElementById("collect-image");
...
<div class="container">
    <div class="col-md-3">
        <ul class="nav nav-pills nav-stacked text-center">
            <li class="active"><a href="<%=basePath%>music/recommend">今日推荐</a></li>
            ...
            <li><a href="<%=basePath%>music/myupload">我的上传</a></li>
            <li><a href="<%=basePath%>music/createsongsheet">歌单创建</a></li>
        </ul>
    </div>
    <div class="col-md-9">
        <div class="itemTitle text-center">
            <strong style="font-size: 150%">今日推荐</strong>
        </div>
        <table class="table table-striped table-hover" style="margin-top: 10px">
            ...
            <tbody>
            <s:iterator var="song" value="#request.my_recommend" status="st">
                <tr>
                    ...
                    <td class="collect">
                        <a href="javascript:void(0);" id="collect_operation" onclick="confirm_Collect('<%=user.getId()%>','<s:property value="#song.song_id"/>')"><img class="img-responsive operateItem" id="collect-image"
