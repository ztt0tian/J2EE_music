...
<head>
    ...
    <link href="<%=basePath %>css/singer.css" rel="stylesheet">
...
<div class="top row">
    ...
    <div class="navbar">
        <ul class="nav nav-pills nav-justified">
            ...
            <li   class="active" ><a href="<%=basePath %>pages/singer.jsp"><strong>歌手</strong></a></li>
...
<div class="container all-singer">
    <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked text-center">
            <li class="active"><a href="#">全部歌手</a></li>
    ...
    <div class="col-md-8 num">
        <a href="#" class="Word_a btn btn-primary active"><strong>热门</strong></a>
        <a href="#" class="Word_a">A</a>
        <a href="singer-all-b.html" class="Word_a">B</a>
        <a href="#" class="Word_a">C</a>
        <a href="#" class="Word_a">D</a>
        <a href="#" class="Word_a">E</a>
        <a href="#" class="Word_a">F</a>
        <a href="#" class="Word_a">G</a>
        <a href="#" class="Word_a">H</a>
        <a href="#" class="Word_a">I</a>
        <a href="#" class="Word_a">J</a>
        <a href="#" class="Word_a">K</a>
        <a href="#" class="Word_a">L</a>
        <a href="#" class="Word_a">M</a>
        <a href="#" class="Word_a">N</a>
        <a href="#" class="Word_a">O</a>
        <a href="#" class="Word_a">P</a>
        <a href="#" class="Word_a">Q</a>
        <a href="#" class="Word_a">R</a>
        <a href="#" class="Word_a">S</a>
        <a href="#" class="Word_a">T</a>
        <a href="#" class="Word_a">U</a>
        <a href="#" class="Word_a">V</a>
        <a href="#" class="Word_a">W</a>
        <a href="#" class="Word_a">X</a>
        <a href="#" class="Word_a">Y</a>
        <a href="#" class="Word_a">Z</a>
        <a href="#" class="Word_a">其他</a>
    </div>
</div>
