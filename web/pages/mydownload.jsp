...
<div class="top row">
    ...
    <div class="navbar">
        <ul class="nav nav-pills nav-justified">
            ...
            <li   class="active" ><a href="<%=basePath %>pages/mymusic.jsp"><strong>我的音乐</strong></a></li>
        </ul>
    </div>
</div>
<div class="container">
    <div class="col-md-3">
        <ul class="nav nav-pills nav-stacked text-center">
            ...
            <li class="active"><a href="<%=basePath%>music/mydownload">我的下载</a></li>
    ...
    <div class="col-md-9">
        <div class="itemTitle text-center">
            <strong style="font-size: 150%">我的下载</strong>
        </div>
        <table class="table table-striped table-hover" style="margin-top: 10px">
            ...
            <tbody>
            <s:iterator var="song" value="#request.my_download" status="st">
                <tr>
